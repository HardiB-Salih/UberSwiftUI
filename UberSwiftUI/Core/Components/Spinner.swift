...
struct Spinner: View {
    ...
    let height: CGFloat
    let width: CGFloat
    let primaryColor: UIColor = .secondaryLabel
    let secondaryColor: UIColor = .systemBlue
    ...
    var body: some View {
        ZStack {
            ...
            ZStack {
                // S3
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS3, color: Color(secondaryColor), lineWidth: lineWidth)

                // S2
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS2, color: Color(secondaryColor), lineWidth: lineWidth)

                // S1
                SpinnerCircle(start: spinnerStart, end: spinnerEndS1, rotation: rotationDegreeS1, color: Color(primaryColor), lineWidth: lineWidth)
